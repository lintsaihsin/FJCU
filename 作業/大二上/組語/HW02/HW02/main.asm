...
ddown:
    ...
    .if ah != 0 && currentY < maxY && direction != 3;有按下且按上沒反應
        inc currentY
...
uup:
    ...
    .if ah != 0 && currentY > 0  && direction != 2;有按上且按下沒反應
        dec currentY
...
lleft:
    ...
    .if ah != 0 && currentX > 0 && direction != 0;有按左且按右沒反應
        dec currentX
...
rright:
    ...
    .if ah != 0 && currentY < maxY && direction != 1;有按右且按左沒反應
        inc currentX
